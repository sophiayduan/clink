//THIS IS NOT MY CODE, it is the E-ink vendor's sample code that i'll be using to test it upon arrival. I'll write my own firmware for my use case while it is shipping.
